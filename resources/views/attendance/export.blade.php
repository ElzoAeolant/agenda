      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.success) {
            ...
            @can('attendance.changehour')
            let editbutton = '<a rel="tooltip" class="btn btn-link"  href="#" onclick="enableCheckIn('+response.id+')" data-original-title="" title="">'+
                             '<i class="material-icons">edit</i>'+
                             '<div class="ripple-container">'+edit+'</div>'+
                             '</a>';
            $("#attendance_in_" + response.id).append('<div id="todelete">'+response.time+editbutton+'</div>');
            @else
            $("#attendance_in_" + response.id).append('<div id="todelete">'+response.time+'</div>');
            @endcan
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          if (response.success) {
            ...
            @can('attendance.changehour')
            //Se marca la hora en la que el servidor registró la asistencia y el color del texto
            let editbutton = '<a rel="tooltip" class="btn btn-link"  href="#" onclick="enableCheckOut('+response.id+')" data-original-title="" title="">'+
                             '<i class="material-icons">edit</i>'+
                             '<div class="ripple-container">'+edit+'</div>'+
                             '</a>';
        ...
        success: function(response) {
          if (response.success != null) {
            ...
            for (let i = 0; i < len; i++) {
              ...
              let editbuttonIn = '<a rel="tooltip" class="btn btn-link"  href="#" onclick="enableCheckIn('+id+')" data-original-title="" title="">'+
                             '<i class="material-icons">edit</i>'+
                             '<div class="ripple-container">'+edit+'</div>'+
                             '</a>';
              ...
              let editbuttonOut = '<a rel="tooltip" class="btn btn-link"  href="#" onclick="enableCheckOut('+id+')" data-original-title="" title="">'+
                             '<i class="material-icons">edit</i>'+
                             '<div class="ripple-container">'+edit+'</div>'+
                             '</a>';
              ...
              if (attendance_in == '') {
                ...
                @else
                    attendance_in = checkBoxIn+'<div id="todelete">'+attendance_in+'</div>'
                @endcan
              }
              if (attendance_out == '') {
                ...
                @else
                     attendance_out = checkBoxOut+'<div id="todelete">'+attendance_out+'</div>'
                @endcan
               
              }
              student.append("<tr>" + "<td>" + name + "</td>" + "<td class='text-"+attendance_color_in+"' id='attendance_in_"+id+"'>" + attendance_in + "</td>" + "<td class='text-"+attendance_color_out+"'id='attendance_out_"+id+"'>" + attendance_out + "</td>" + "</tr>");
            }
