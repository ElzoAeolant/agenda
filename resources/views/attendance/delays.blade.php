@extends('layouts.app', ['activePage' => 'attendance.delays', 'titlePage' => __('Attendance Management')])
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header card-header-primary">
                        <h4 class="card-title">{{ __('Consultar registro de asistencia') }}</h4>
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <input type='text' value="{{now()}}" id='datetimepicker' class="form-control" />
                            </div>
                        </div>
                        <div class="row">
