...
<script type="text/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/serviceworker.js', {
            ...
            console.log('Agenda JEBP:  ServiceWorker registration successful with scope: ', registration.scope);
        }, function (err) {
            // registration failed :(
            console.log('Agenda JEBP: ServiceWorker registration failed: ', err);
        });
    }else{
        console.log('Agenda JEBP: Not Service worker in Navigator');
    }
</script>
